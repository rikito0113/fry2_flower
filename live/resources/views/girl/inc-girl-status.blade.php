...
<div class="row girl-status-bg-dere" style="margin:0px;">
@else
<div class="row girl-status-bg-tsun" style="margin:0px;">
@endif
    ...
    @if ($page == 'main_chat')
        <div class="col-2 col-sm-2 col-md-2 offset-2 offset-sm-2 offset-md-2" style="padding:7px;">
            ...
            <p class="girl-status-chat-name">{{ $owned_char_info->char_name }}</p>
            <p class="girl-status-chat-name-purple">{{ $owned_char_info->char_name }}</p>
        </div>
    ...
    @elseif ($page == 'status')
        <div class="col-2 col-sm-2 col-md-2 offset-4 offset-sm-4 offset-md-4" style="padding:7px;">
            <a href="/Girl/index"><img src="{{ asset('/images/icon/icon_back.png') }}" alt="bg_header_clock_dere" class="fit-img100"></a>
