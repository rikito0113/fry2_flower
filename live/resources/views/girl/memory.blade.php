...
<div width="100%">
    <img src="{{ asset('/images/titlebar/obi_cap3.png') }}" alt="日常メモリー">
    <div>2020年7月->夏</div>
    @for ($i = 0; $i < 12; $i++)
        @if ($i % 4 == 0)
            <br />
        ...
        <span>
            @if ($i + 1 > $event_memory_length)
                <img src="{{ asset('/images/icon/bt_mem_place_seacret.png') }}" alt="シークレット">
                <p class="mem_frame">?????</p>
            @else
                <img src="{{ asset('/images/icon/bt_mem_place'.$event_memory[$i]->scenario_id.'.png') }}" alt="開放済み">
...
<div width="100%">
    <img src="{{ asset('/images/titlebar/obi_cap4.png') }}" alt="えっちなメモリー">
