...
Route::post('/Profile/changeNameExec/{$changeName}',      'ProfileController@changeNameExec');
...
Route::view('/Profile/changeNameConfirm',                 'profile.change_name_confirm')->name('profile.changeNameConfirm');
